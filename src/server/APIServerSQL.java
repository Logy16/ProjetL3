...
public interface APIServerSQL {
	...
	/**
	 * Retourne l'utilisateur recherché à partir du nom et du prénom
	 * ATTENTION : NE RETOURNE AUCUN GROUPE DANS L'UTILISATEUR
	...
	/**
	 * Retourne l'utilisateur recherché à partir de son identifiant
	 * ATTENTION : NE RETOURNE AUCUN GROUPE DANS L'UTILISATEUR
	...
	/**
	 * Permet d'ajouter ou d'update un utilisateur à la base de données.
	 * Si l'utilisateur est déjà dans la base de données, met à jour ses valeurs, et le crée sinon.
	 * ATTENTION : MET EGALEMENT A JOURS LA LISTE DES GROUPES DE L'UTILISATEUR ! (ne pas utiliser juste après getUtilisateur, car getUtilisateur ne donne pas de groupe)
	 * @param utilisateur : L'utilisateur à écrire dans la base de données
	 * @return true si jamais un utilisateur de même identifiant était déjà présent, false sinon
	 * @author Liouss
	 * **/
	...
	/**
	 * Permet d'ajouter un fil à la base de données.
	 * ATTENTION : N'AJOUTE PAS ET NE MET PAS A JOURS LES MESSAGES LIÉS A CE FIL
	 * @param fil : Le fil à écrire dans la base de données
	 * @return false si jamais un fil de même identifiant était déjà présent, true sinon
	 * @author Liouss
	 * **/
	...
	/**
	 * Permet d'ajouter un groupe à la base de données.
	 * ATTENTION : NE MET PAS A JOURS LES UTILISATEURS APPARTENANT AU GROUPE, NI LA LISTE DES UTILISATEURS DU GROUPE ELLE-MÊME
	 * ATTENTION : NE SERT QU'A CREER UN GROUPE
	 ...
	 * @param utilisateur : l'utilisateurqui a lu le message
	 * @author Liouss
	 * **/
